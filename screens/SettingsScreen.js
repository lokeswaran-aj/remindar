...
export default class SettingsScreen extends Component {
        ...
        for (let i = 0; i < 30; i++) {
            customDatesStyles.push({
                ...
                style: {
                    ...
                    //     (
                    //         "#00000" +
                    //         ((Math.random() * (64 << 22)) | 32768).toString(16)
                    //     ).slice(-6),
                },
    ...
    onMinRangeDuration(val) {
        ...
        this.setState({
            minRangeDuration:
                val && !isNaN(parsedVal) ? parsedVal + "" : undefined,
            selectedStartDate: null,
            selectedEndDate: null,
        });
    }
        ...
        return (
            <View style={styles.container}>
                <CalendarPicker
                    ...
                    minRangeDuration={
                        minRangeDuration && parseInt(minRangeDuration)
                    }
                    maxRangeDuration={
                        maxRangeDuration && parseInt(maxRangeDuration)
                    }
